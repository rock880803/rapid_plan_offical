...
export const projectsData: Project[] = [
  {
    ...
    image: '/images/project_images/ntust-logo-1.png',
    images: [
      '/images/project_images/ntust-logo-1.png',
      '/images/project_images/ntust-logo-2.png',
      '/images/project_images/ntust-logo-3.png'
    ],
    category: '品牌設計',
